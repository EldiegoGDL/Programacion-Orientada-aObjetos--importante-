...
public class App extends JFrame implements ActionListener {    // La App hereda JFrame e implementa ActionListener.
    ...
    JDialog jdlAcercaDe;
    JLabel lblDatos, lblNombre, lblEdad, lblSalario, lblEstadocivil,lblDescripcion,lblSexo;   // se crea el arreglo para los datos y los objetos de los componentes interfaz
    ...
    JButton btnAgregar, btnGrabar;    // se cran 2 botones para la funcionalidad de agregar y grabar un liga
public App(){
    ...
    lblDatos = new JLabel("<html>Programación Oriendada a Objetos I<br>Diego Ignacio Garcia Diaz de Leon</html>",JLabel.CENTER);   // creamos un cuadro de dialogo
    ...
    modelo.setColumnIdentifiers(new String[]{"Nombre","Edad","Salario","Estado Civil","Descripcion","Sexo"});   // se crea el modelo de la tabla y las columnas y titulos
    ...
    pnlDatos.add(lblEdad);                     // se crea unpanel para los datos en grid con columnas 6x2 donde se colocan etiquetas y cuadros de texto
...
// se crea el metodo para responder los eventos de salir y acerca de
    ...
    public void mostrarDatos(int ren) {
        ...
        public void guardarCampos() {
            ...
            est.setSalario( Double.parseDouble(txtSalario.getText()) );       // crea un nuevo estudiante en base a la informacion capturada en los cuadros de texto y lo agrega a los datos y recarga la tabla
